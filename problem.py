...
class WeightedClassificationError(rw.score_types.BaseScoreType):
    ...
    def __init__(self, name="WeightedClassificationError", precision=2, time_idx=0):
...
class WeightedCrossEntropy(rw.score_types.BaseScoreType):
    ...
    def __init__(self, name="WeightedCrossEntropy", precision=2, time_idx=0, eps=1e-15):
        """init
...
class AreaUnderCurveError(rw.score_types.BaseScoreType):
    ...
    def compute(self, y_true, y_pred):
        ...
        for time_idx in range(n_times):
            ...
            self.errors[time_idx] = score_func.compute(y_true=y_true, y_pred=preds)
